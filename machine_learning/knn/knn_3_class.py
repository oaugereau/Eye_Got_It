...
plt.savefig('confusionMatrixKnn3Class.png')
plt.clf()
...
plt.legend()
plt.savefig('validationCurveKnn3Class.png')
plt.clf()
...
plt.savefig('confusionMatrixGridKnn3Class.png')
plt.clf()
...
plt.legend()
plt.savefig('learingCurveKnn3Class.png')
plt.clf()

import seaborn as sb 
sb.pairplot(data = df, hue = 'class', palette = ['Red', 'Blue','green'],height=2.5)
plt.savefig('pairplotKnn3Class.png')
plt.clf()