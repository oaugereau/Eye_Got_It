...
plt.savefig('confusionMatrixKnn3ClassTest.png')
plt.clf()
...
plt.legend()
plt.savefig('validationCurveKnn3ClassTest.png')
plt.clf()
...
plt.savefig('confusionMatrixGridKnn3ClassTest.png')
plt.clf()

from sklearn.model_selection import learning_curve
N, train_score, val_score = learning_curve(model2,X_train,Y_train, 
                                           train_sizes = [25,50,75,100,147],
                                           cv = 6)
#print(N)
...
plt.legend()
plt.savefig('learingCurveKnn3ClassTest.png')
plt.clf()

import seaborn as sb 
sb.pairplot(data = df, hue = 'class', palette = ['Red', 'Blue','green'],height=2.5)
plt.savefig('pairplotKnn3ClassTest.png')
plt.clf()