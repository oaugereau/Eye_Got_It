...
plt.savefig('confusionMatrixSvm3Class.png')
plt.clf()
...
plt.legend()
plt.savefig('validationCurveSvm3Class.png')
plt.clf()
...
plt.savefig('confusionMatrixGridSvm3Class.png')
plt.clf()
...
plt.legend()
plt.savefig('learingCurveSvm3Class.png')
plt.clf()

import seaborn as sb 
sb.pairplot(data = df, hue = 'class', palette = ['Red', 'Blue','green'],height=2.5)
plt.savefig('pairplotSvm3Class.png')
plt.clf()