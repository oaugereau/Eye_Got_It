...
plt.savefig('confusionMatrixSvmClass.png')
plt.clf()
...
plt.legend()
plt.savefig('validationCurveSvmClass.png')
plt.clf()
score = []
...
plt.savefig('confusionMatrixGridSvmClass.png')
plt.clf()
dump(model2, 'svm2classes.joblib')
...
plt.legend()
plt.savefig('learingCurveSvmClass.png')
plt.clf()

import seaborn as sb 
sb.pairplot(data = df, hue = 'class', palette = ['Red', 'Blue'],height=2.5)
plt.savefig('pairplotSvmClass.png')
plt.clf()
