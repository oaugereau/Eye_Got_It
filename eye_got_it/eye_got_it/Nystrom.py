...
def Nystrom(convertedGazes):
    ...
    while i < len(convertedGazes):
        ...
        i+=1
    percentageGazes = 100*(len(gazeInFixation)/len(convertedGazes))
    #print("pourcentage lo ", percentageGazes)
    #print("convertedGaze ", convertedGazes)
    #print("gazesIn ", gazeInFixation)
    #print("velocity treshold=",vtn)
    return sacTab,gliTab,fixTab,percentageGazes
